...
export default {
    ...
    methods:{
        handleCurrentChange(val) {
            this.loading=true
            this.fetchData(api.brandGroup+'?page='+(this.currentPage-1)+'&size='+this.pageSize,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
        ...
        add(form) {
            this.$refs[form].validate((valid) => {
                if (valid) {
                    ...
                    this.subForm(api.brandGroup,this.form,(data) => {
        ...
        deleteRow(index , data) {
            this.$confirm('确定删除吗？', '提示', {
                ...
                this.deleteData(api.brandGroup+'/'+data[index].pkGlobalId,'',(data) => {
                    this.reData()
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
        ...
        modify() {
            ...
            this.patchData(api.brandGroup+'/'+this.modifyForm.pkGlobalId,this.modifyForm,(data) => {
