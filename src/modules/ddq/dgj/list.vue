    ...
    <div class="content">
        ...
        <template>
            <el-table :data="dataList.content" border style="width: 100%" :height="autoHeight" v-loading="loading">
                ...
                <el-table-column label="客户自有商品" min-width="150">
...
export default {
    ...
    methods:{
        handleCurrentChange(val) {
            ...
            let _searchData = ''
            if(this.phoneSearch){
                _searchData+='&operator.phone='+this.phoneSearch
            }
            this.fetchData(api.dgjList+'?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize+_searchData,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
