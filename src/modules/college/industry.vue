...
onEditorReady(editor) {
    this.editor = editor
        ...
        handleCurrentChange(val) {
            this.loading=true
            this.fetchData(api.college+'/industry?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
...
this.form.content=this.editCon
                    this.subForm(api.college+'/industry',this.form,(data) => {
        ...
        deleteRow(index , data) {
            this.$confirm('确定删除吗？', '提示', {
                ...
                this.deleteData(api.college+'/industry/'+data[index].id,'',(data) => {
                    this.reData()
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
...
this.modifyForm.content=this.editCon
            this.patchData(api.college+'/industry/'+this.modifyForm.id,this.modifyForm,(data) => {
