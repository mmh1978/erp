...
onEditorReady(editor) {
    this.editor = editor
        ...
        handleCurrentChange(val) {
            this.loading=true
            this.fetchData(api.college+'/share?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
...
this.form.content=this.editCon
                    this.subForm(api.college+'/share',this.form,(data) => {
        ...
        deleteRow(index , data) {
            this.$confirm('确定删除吗？', '提示', {
                ...
                this.deleteData(api.college+'/share/'+data[index].id,'',(data) => {
                    this.reData()
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
...
this.modifyForm.content=this.editCon
            this.patchData(api.college+'/share/'+this.modifyForm.id,this.modifyForm,(data) => {
