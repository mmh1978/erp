...
<template>
    <div class="content">
        ...
        <el-dialog title="添加分享" :visible.sync="addState" size="full" :before-close="addHandleClose">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px" v-loading="addLoading">
                ...
                <el-form-item label="页面标题" prop="seoTitle">
                 ...
                 <el-form-item label="关键词" prop="seoWord">
...
<quill-editor ref="myTextEditor" v-model="editCon" :options="editorOption" @focus="onEditorFocus($event)" @ready="onEditorReady($event)">
    <div id="toolbar" slot="toolbar" class="ql-toolbar ql-snow">
        ...
        <el-dialog title="修改分享" :visible.sync="modifyState" size="full" :before-close="modifyHandleClose">
            <el-form ref="modifyForm" :model="modifyForm" :rules="modifyRules" label-width="80px" v-loading="modifyLoading">
                ...
                <el-form-item label="页面标题" prop="seoTitle">
                    <el-input v-model="modifyForm.seoTitle"></el-input>
                </el-form-item>
                 <el-form-item label="关键词" prop="seoWord">
                    <el-input v-model="modifyForm.seoWord"></el-input>
                </el-form-item>
                 <el-form-item label="描述" prop="seoDesc">
                    <el-input v-model="modifyForm.seoDesc"></el-input>
                </el-form-item>
                <el-form-item label="封面图片" prop="image">
...
onEditorReady(editor) {
    this.editor = editor
        ...
        handleCurrentChange(val) {
            this.loading=true
            this.fetchData(api.college+'/category?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
...
this.form.content=this.editCon
                    this.subForm(api.college+'/category',this.form,(data) => {
        ...
        deleteRow(index , data) {
            this.$confirm('确定删除吗？', '提示', {
                ...
                this.deleteData(api.college+'/category/'+data[index].id,'',(data) => {
                    this.reData()
                    this.$message({
                        type: 'success',
                        message: '删除成功!'
...
this.modifyForm.content=this.editCon
            this.patchData(api.college+'/category/'+this.modifyForm.id,this.modifyForm,(data) => {
