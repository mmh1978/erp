...
<template>
    <div class="content">
        ...
        <template>
            <el-table :data="dataList.content" border style="width: 100%" :height="autoHeight" v-loading="loading">
                <el-table-column prop="id" label="入库单编号" width="120"></el-table-column>
                <el-table-column prop="jxcPurchase.id" label="采购单号" min-width="100"></el-table-column>
                <el-table-column prop="jxcPurchase.createTime" label="采购时间" width="180"></el-table-column>
                <el-table-column prop="jxcPurchase.operator.name" label="采购人" width="100"></el-table-column>
                ...
                <el-table-column prop="user.name" label="操作人" width="100"></el-table-column>
                <el-table-column prop="createTime" label="入库日期" width="180"></el-table-column>
        ...
        <el-dialog title="添加入库单" :visible.sync="addState" size="large">
            <el-form ref="form" :model="form" :rules="rules" label-width="100px" v-loading="addLoading">
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="采购单" prop="id">
                            <el-col :span="18">
                            ...
                            <el-col :span="5">
                                <el-popover ref="popover" placement="bottom" width="1200" trigger="click" @show="oddRemoteMethod">
                                    <el-form :inline="true">
                                        <el-form-item><el-input v-model="innerSName" placeholder="采购单号"></el-input></el-form-item>
                                    ...
                                    <el-table :data="oddNumList.content" border style="width: 100%;max-height:500px" v-loading="oddNumLoading" height="400">
                                        <el-table-column min-width="100" property="id" label="采购单号"></el-table-column>
                                        <el-table-column min-width="100" property="supplier.name" label="供应商"></el-table-column>
                                        <el-table-column width="100" property="goodsNumber" label="商品数量"></el-table-column>
                                        ...
                                        <el-table-column property="operator.name" label="操作员"></el-table-column>
                                        <el-table-column property="check1.name" label="审核人"></el-table-column>
  ...
  <el-select v-model="form.baseId" placeholder="请选择" style="width:100%">
    <el-option
      ...
      :value="item.id">
                ...
                <el-form-item label="采购明细">
                    <el-table :data="purchaseList" border style="width: 100%">
                        ...
                        <el-table-column min-width="100" property="typeName" label="型号名称"></el-table-column>
        ...
        <el-dialog title="查看详情" :visible.sync="showState" size="large">
            <el-form :model="showForm" label-width="100px">
                <el-row>
                    <el-col :span="8">
                        <el-form-item label="编号" prop="">
                            <el-input v-model="showForm.showId" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="采购人员" prop="">
                            <el-input v-model="showForm.operator.name" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="8">
                        <el-form-item label="采购时间" prop="">
                ...
                <el-form-item label="采购明细" v-if="purchaseList.length>0">
                    <el-table :data="purchaseList" border style="width: 100%">
                        <el-table-column min-width="100" property="id" label="产品ID"></el-table-column>
                        <el-table-column width="100" property="purchaseDetail.categoryName" label="品类名称"></el-table-column>
                        <el-table-column width="100" property="purchaseDetail.brandName" label="品牌名称"></el-table-column>
                        <el-table-column min-width="180" property="purchaseDetail.typeName" label="型号名称"></el-table-column>
                        <el-table-column min-width="200" property="purchaseDetail.name" label="名称"></el-table-column>
                        <el-table-column width="80" property="base.name" label="仓库"></el-table-column>
                        <el-table-column width="80" property="purchaseDetail.number" label="数量"></el-table-column>
                        <el-table-column width="90" property="purchaseDetail.price" label="成本价"></el-table-column>
                        <el-table-column width="90" property="purchaseDetail.samePrice" label="同行价"></el-table-column>
                        <el-table-column width="160" property="purchaseDetail.sameRate" label="同行销售提成"></el-table-column>
                        <el-table-column width="80" property="purchaseDetail.customerPrice" label="客户价"></el-table-column>
                        <el-table-column width="160" property="purchaseDetail.customerRate" label="客户销售提成"></el-table-column>
                        <el-table-column min-width="180" property="purchaseDetail.memo" label="备注"></el-table-column>
                    </el-table>
                </el-form-item>
                <el-form-item>
...
export default {
    ...
    methods:{
        handleCurrentChange(val) {
            ...
            this.fetchData(api.goodsinManagement+'?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize+_searchData,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
        ...
        curChange(val) {
            ...
            this.fetchData(api.purchaseManagement+'?status=02&page='+(this.curPage-1)+'&size='+this.pSize+_searchData,'',(data) => {
        ...
        add(form) {
            ...
            if(this.form.baseId){
                this.form.baseId=this.form.baseId.toString()
            }
            this.$refs[form].validate((valid) => {
                if (valid) {
                    ...
                    this.subForm(api.goodsinManagement,_p,(data) => {
        ...
        edit(editForm) {
            ...
            this.$refs[editForm].validate((valid) => {
                if (valid) {
                    ...
                    this.patchData(api.goodsinManagement+'/'+this.editId,_p,(data) => {
        ...
        deleteRow(index , data) {
            this.$confirm('确定撤销吗？', '提示', { confirmButtonText: '确定', cancelButtonText: '取消', type: 'warning' }).then(() => {
                this.patchData(api.goodsinManagement+'/revoked/'+data[index].id,'',(data) => {
                    this.reData()
        ...
        showDetail(index , data){
            this.refId = data[index].jxcPurchase.id
            this.price = data[index].price
            this.goodsNumber = data[index].goodsNumber
            if(data[index].jxcPurchase){
                this.showForm=data[index].jxcPurchase
                this.showForm.showId=data[index].id
            }
            this.purchaseList=[]
            this.fetchData(api.goodsinDetail+'?refId='+data[index].id,'',(redata) => {
                console.log(redata)
                if(!!redata.content){
                    this.purchaseList = redata.content
                }
        ...
        oddRemoteMethod() {
            this.fetchData(api.purchaseManagement+'?status=02','',(data) => {
                this.oddNumList=data
        ...
        selectOdd(index , data){
            ...
            this.fetchData(api.purchaseDetail+'?refId='+this.form.id,'',(redata) => {
                if(!!redata.content){
                    this.purchaseList = redata.content
                }
            })
        ...
        subVerify(){
            this.patchData(api.goodsinManagement+'/check/'+this.verifyId,this.verifyForm,(data) => {
                this.reData()
        ...
        pay(payForm) {
            this.$refs[payForm].validate((valid) => {
                if (valid) {
                    ...
                    this.subForm(api.goodsinManagement+'/payment?id='+this.refId,_data,(data) => {
                        this.payState=false
                        this.reData()
                        this.$message({message: '恭喜你，保存成功',type: 'success'})
                    })
        ...
        goodsin(){
            ...
            this.subForm(api.goodsinManagement+'/goodsin?id='+this.refId,_p,(data) => {
