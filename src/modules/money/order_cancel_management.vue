        ...
        <template>
            <el-table :data="dataList.content" border style="width: 100%" :height="autoHeight" v-loading="loading">
                ...
                <el-table-column prop="status" label="退款状态" min-width="120">
                    <template slot-scope="scope">
                        <template v-if="dataList.content[scope.$index].order.returnStatus=='0'">待确认</template>
                        <template v-if="dataList.content[scope.$index].order.returnStatus=='1'">已退款</template>
                    </template>
                </el-table-column>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="支付方式" prop="">
                                    <el-select v-model="detail.order.payType" placeholder="请选择" style="width:100%" disabled>
                            ...
                            <el-col :span="6">
                                <el-form-item label="收款状态" prop="">
                                    <el-select v-model="detail.order.collectStatus" placeholder="请选择" style="width:100%" disabled>
                        ...
                        <el-row>
                            <el-col :span="6">
                                <el-form-item label="退款状态" prop="">
                                    <el-select v-model="detailStatus.returnStatus" placeholder="请选择" style="width:100%">
                            ...
                            <el-col :span="6">
                                <el-form-item label="流水单号" prop="">
                                    <el-input v-model="detailStatus.turnover2"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="6">
                                <el-form-item label="退款金额" prop="">
                                    <el-input v-model="detailStatus.returnMoney"></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="6">
                                <el-form-item>
...
export default {
    ...
    methods:{
        handleCurrentChange(val) {
            ...
            this.fetchData(api.ordersList+'?status=10&status=5&sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize+_searchData,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
        ...
        showModify(index , data) {
            ...
            this.detailStatus.returnStatus=data[index].order.returnStatus
            this.detailStatus.returnMoney=data[index].order.returnMoney
            this.detailStatus.turnover2=data[index].order.turnover2
