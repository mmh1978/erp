    ...
    <div class="content">
        <div class="top-bar">
            <div class="item">
                <el-form :inline="true">
                    <el-form-item label="">
                        <el-input v-model="idSearch" placeholder="收款单编号" type="text"></el-input>
                    </el-form-item>  
                    <el-form-item>
        ...
        <template>
            <el-table :data="dataList.content" border style="width: 100%" :height="autoHeight" v-loading="loading">
                <el-table-column prop="id" label="收款单编号" width="120"></el-table-column>
        ...
        <el-dialog title="添加收款明细" :visible.sync="addCollectState" size="tiny">
        ...
        <el-dialog title="添加收款单" :visible.sync="addState" size="large">
        ...
        <el-dialog title="添加明细" :visible.sync="modifyState" size="large">
            <el-form ref="modifyForm" :model="modifyForm" :rules="modifyRules" label-width="100px" v-loading="modifyLoading">
                ...
                <el-form-item label="收款明细" v-if="payList.length>0">
                    <el-table :data="payList" border style="width: 100%">
                        ...
                        <el-table-column width="100" property="money" label="收款金额"></el-table-column>
                        <el-table-column min-width="100" property="memo" label="备注"></el-table-column>
                        <el-table-column fixed="right" label="操作" width="70">
                            <template slot-scope="scope">
                ...
                <el-form-item>
                    <el-button @click="addCollectState = true">添加收款明细</el-button>
...
export default {
    ...
    methods:{
        handleCurrentChange(val) {
            this.loading=true
            this.fetchData(api.collectManagement+'?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize,'',(data) => {
                this.dataList=data
                this.loading=false
            })
        },
        reData() {
            ...
            this.fetchData(api.collectManagement+'?sort=createTime,desc&page='+(this.currentPage-1)+'&size='+this.pageSize+_searchData,'',(data) => {
                this.dataList=data
                this.loading=false
                console.log(data)
            })
        ...
        add(form) {
            ...
            this.$refs[form].validate((valid) => {
                if (valid) {
                    ...
                    this.subForm(api.collectManagement,_p,(data) => {
                ...
                if (valid) {
                    ...
                    for(let i in this.payList){
                        let _p={
                            ...
                            "collectItem":this.modifyForm.collectItem,
                    ...
                    if(_arr.length>0){
                        this.subForm(api.collectDetailManagement+'/batchCreate',_arr,(data) => {
